...
{
    public class BMFactory : IComponentFactory
    {
        private BMComponent _instance;
        ...
        {
            get { return "Automates splitting and load removal for Hitman: Blood Money."; }
        }
        ...
        public IComponent Create(LiveSplitState state)
        {
            ...
            return (_instance = new BMComponent(state, createAsLayoutComponent));
        }
